...
<body style="padding-top: 70px;">
    ...
    <header class="navbar navbar-expand-lg fixed-top bg-light pt-3 pb-3 mb-4" style="background-color: #E4D9D9 !important; top: 0;">
...
<section class="h-100 h-custom m-5" style="background-color: #E4D9D9;" >
          ...
          <div class="card-body p-4">
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                ...
                <div class="card bg-primary text-white rounded-3" style="background-color: #E03ED8 !important;">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-info btn-block btn-lg" style="background-color: white; border-color: white;">
                      <div class="d-flex justify-content-between" >
                        <a href="/adresa">
                        <span>$4818.00</span>
                        <span>Checkout <i class="bi bi-arrow-right ms-2"></i></span></a>
                      </div>
                    </button>
